...
This folder defines all source code for the 'lakeflow_sdp' pipeline:
...
* Take a look at the sample under "sample_users_lakeflow_sdp.py" to get familiar with the syntax.
